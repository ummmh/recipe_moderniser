...
def instructions():
    ...
    print("The program also asks for the number of servings. If you are not sure,\n"
          "type '1'. Then when it asks for servings needed, you can increase\n"
          "or decrease the amount (e.g. 2 or 1/2) and the program will scale\n"
          "the ingredient amounts for you.")
    print()
